...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`wenx` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
/*Table structure for table `wx_goods_brand` */

DROP TABLE IF EXISTS `wx_goods_brand`;

CREATE TABLE `wx_goods_brand` (
...
/*Data for the table `wx_goods_brand` */

insert  into `wx_goods_brand`(`id`,`brand_name`,`brand_img`,`sort`,`is_hot`,`create_time`,`update_time`) values 
(12,'锤子','/uploads/images/20180621/bf24fa42e3244c73617862412e930c3d.jpg',0,0,1529573989,1529573989),
(10,'荣耀','/uploads/images/20180621/d69f506c21cba1e56edf5d04c948d09f.jpg',0,0,1529573962,1529573962),
(11,'小米','/uploads/images/20180621/89863ade0be070f903cc64473bcb1ad8.jpg',0,0,1529573975,1529573975),
(9,'联想','/uploads/images/20180621/cb58674be0d5557ea5d0c62b3130ab1a.jpg',0,0,1529573941,1529573941),
(7,'魅族','/uploads/images/20180621/ec68d51b45fd895189625e933469d768.jpg',0,0,1529573915,1529573915),
(8,'华为','/uploads/images/20180621/21670a819df06603e0b93205b42d4440.jpg',0,0,1529573929,1529573929);

/*Table structure for table `wx_goods_category` */
...
CREATE TABLE `wx_goods_category` (
  ...
  `category_bname` varchar(50) DEFAULT NULL COMMENT '别名',
  `category_img` varchar(255) DEFAULT NULL COMMENT '分类图片',
  `is_show` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0,不显示，1显示',
  `pid` int(11) NOT NULL DEFAULT '0' COMMENT '父级，0顶级',
  `sort` int(4) NOT NULL DEFAULT '0' COMMENT '排序',
  `is_hot` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0否，1是',
  `create_time` int(10) DEFAULT NULL,
  `update_time` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;

/*Data for the table `wx_goods_category` */

insert  into `wx_goods_category`(`id`,`category_name`,`category_bname`,`category_img`,`is_show`,`pid`,`sort`,`is_hot`,`create_time`,`update_time`) values 
(1,'手机 、 数码 、 通信','数码产品',NULL,1,0,0,0,NULL,NULL),
(2,'家用电器','家用电器',NULL,1,0,0,0,NULL,NULL),
(3,'电脑、办公','电脑','/uploads/images/20180622/b300f2d6f058b06d7653b6e929ff4ae7.jpg',1,0,0,0,1529633844,1529633844),
(4,'家居、家具、家装、厨具','家具',NULL,1,0,0,0,1529636532,1529636532),
(5,'男装、女装、童装、内衣','服装',NULL,1,0,0,0,1529636607,1529636607),
(6,'鞋、箱包、珠宝、手表','箱包',NULL,1,0,0,0,1529636626,1529636626),
(7,'运动户外','运动户外',NULL,1,0,0,0,1529636636,1529636636),
(8,'汽车用品','汽车用品',NULL,1,0,0,0,1529636644,1529636644),
(9,'母婴用品、儿童玩具','母婴儿童',NULL,1,0,0,0,1529636657,1529637035),
(10,'图书、音像、电子书','图书、音像',NULL,1,0,0,0,1529636672,1529636672),
(11,'个人化妆','个人化妆',NULL,1,0,0,0,1529636755,1529636755),
(12,'手机配件','手机配件',NULL,0,1,0,0,1529640123,1529640123);

/*Table structure for table `wx_goods_type` */

DROP TABLE IF EXISTS `wx_goods_type`;

CREATE TABLE `wx_goods_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `wx_goods_type` */

insert  into `wx_goods_type`(`id`,`type_name`,`create_time`,`update_time`) values 
(1,'手机',NULL,NULL),
(2,'精品手机',NULL,NULL),
(3,'平板电脑',NULL,NULL),
(4,'相机',NULL,NULL),
(5,'电池、电源、充电器',NULL,NULL),
(6,'路由器',NULL,NULL);
...
(1,'123456','123456','123456',1,'第一个',NULL,NULL,NULL,NULL,1527644633,NULL,NULL,NULL,0);
...
(1,'普通会员',0,NULL,NULL),
(2,'VIP会员',1,1527646894,1527647294),
(3,'钻石VIP',2,1527647364,1527647364),
(4,'超级VIP',3,1527647384,1527647384);
...
(22,'会员管理','','Member/index',0,50,NULL,1,1),
(23,'会员列表','','Member/index',22,50,NULL,1,1),
(24,'添加会员','','Member/add',23,50,NULL,1,1),
(25,'编辑会员','','Member/edit',23,50,NULL,1,1),
(26,'会员状态','','Member/status',23,50,NULL,1,1),
(27,'删除会员','','Member/del',23,50,NULL,1,1),
(28,'会员组','','Group/index',22,50,NULL,1,1),
(29,'添加会员组','','Group/add',28,50,NULL,1,1),
(30,'编辑会员组','','Group/edit',28,50,NULL,1,1),
(31,'删除会员组','','Group/del',28,50,NULL,1,1);
...
/*Table structure for table `wx_spec` */

DROP TABLE IF EXISTS `wx_spec`;

CREATE TABLE `wx_spec` (
...
/*Data for the table `wx_spec` */

/*Table structure for table `wx_spec_item` */

DROP TABLE IF EXISTS `wx_spec_item`;

CREATE TABLE `wx_spec_item` (
...
/*Data for the table `wx_spec_item` */
